...
if (!$this->is_bare()) {
	...
	<a class="brand" href="/">'<i style="background: url('../resources/images/dMineLogoWhite-20.png') no-repeat; width: 101px; height: 96px; text-indent: -9999px; display: inline-block;">dm</i>Data<sup>MINE</sup>'</a>';
